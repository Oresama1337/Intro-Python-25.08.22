...
my_tuple = (1, 2, 3, "qwe", True, ("a", "b"), None, []) # не изменяемый тип
# print(type(my_tuple), my_tuple)

my_list = [1, 2, 3, "qwe", True, ("a", "b"), None, []]  # изменяемый тип
...
# print(words)
#
# ip_adress = "127.255.12.0"
# groups = ip_adress.split(".")
# print(groups)
#
# filename = "/home/volodymir/PycharmProjects/IntroPython_25.08.22"
# path = filename.strip("/").split("/")
# print(path)
#
# new_message = "_".join(words)
# print(new_message)
#
